...
export RobustModel, @uncertain, @adaptive, setuncertaintyset, getscenario, uncvalue

# export adp_str  # zukui add 2017 Dec 13
...
mutable struct RobustModelExt{S,T,U}
	...
	unc_expectation::Vector{Float64}  # zukui add 2017.Dec.13 to store expected value of uncertain parameter
    unc_variance::Vector{Float64}   # zukui add 2017.Dec.16, variance of each uncertain parameter
    unc_cat::Vector{Symbol}
    # Adaptive variables
    num_adps::Int
    adp_names::Vector{String}
	org_names::Vector{Any}  # zukui add 2017.Dec.06  save original name of the advaptive variables
...
RobustModelExt(cutsolver) =
    ...
    Float64[],        #zukui add 2017.Dec.13  expectation
    Float64[],      # zukui 2017.Dec.16   variance
    Symbol[],                   # unc_cat
    # Adaptive variables
    0, String[],                # num_adps, adp_names
	Any[],     # org_names   zukui add 2017.Dec.6
...
include("print_model_statistics.jl")  # zukui added 2018.Jan.10
include("print_decision_rule.jl")  # zukui added 2017.Dec.13

include("lift_uncertainty_set.jl")  # zukui added 2017.Dec.21


#end  # module     # zukui commented

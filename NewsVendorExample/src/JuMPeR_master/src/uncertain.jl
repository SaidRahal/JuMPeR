...
#function Uncertain(m::Model, lower::Number, upper::Number, cat::Symbol, name::AbstractString)  # zukui change 2017.Dec.14
function Uncertain(m::Model, lower::Number, upper::Number, cat::Symbol, name::AbstractString,
    expectation::Any, variance::Any)
	...
	# println("Upper value:", upper)
	# println("Expectation value:",expectation)
	push!(robdata.unc_expectation, convert(Float64, expectation))  # zukui 2017.Dec.14
    push!(robdata.unc_variance, convert(Float64, variance))  # zukui 2017.Dec.16
